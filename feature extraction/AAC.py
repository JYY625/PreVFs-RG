...
fastas = readFasta.readFasta(r"C:\Users\ACER\抗癌肽\ProtConv-master\datasets\proinflammatory\train.txt")
...
kw=  {'path': r"C:\Users\ACER\抗癌肽\ProtConv-master\datasets\proinflammatory",'data':"train.txt",'order':'ACDEFGHIKLMNPQRSTVWYXUO'}
data_AAC=AAC(fastas, **kw)
#AAC=data_AAC.to_list
AAC=pd.DataFrame(data=data_AAC)
AAC.to_csv(r"C:\Users\ACER\抗癌肽\ProtConv-master\datasets\proinflammatory\AAC.csv",header=None)