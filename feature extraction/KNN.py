...
def KNNpeptide(fastas, **kw):
	...
	return encodings
fastas = readFasta.readFasta(r"C:\Users\ACER\deepVF\DeepVF\feature extraction\train.fasta")
kw=  {'path': r"C:\Users\ACER\deepVF\DeepVF\feature extraction",'train':r"C:\Users\ACER\deepVF\DeepVF\feature extraction\train.fasta",'label':r"C:\Users\ACER\deepVF\DeepVF\feature extraction\label.csv",'order':'ACDEFGHIKLMNPQRSTVWYO'}
