...
kw=  {'path': r"C:\Users\ACER\抗癌肽\ProtConv-master\datasets\proinflammatory",'order': 'ACDEFGHIKLMNPQRSTVWY'}
fastas1 = readFasta.readFasta(r"C:\Users\ACER\抗癌肽\ProtConv-master\datasets\proinflammatory\train.txt")

result=DDE(fastas1, **kw)

data1=np.matrix(result[1:])[:,1:]
data_=pd.DataFrame(data=data1)
data_.to_csv(r"C:\Users\ACER\抗癌肽\ProtConv-master\datasets\proinflammatory\DDE.csv",header=None)